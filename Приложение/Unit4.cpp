...
void __fastcall TForm4::Button1Click(TObject *Sender)
{
	...
	Form4->ADOQuery1->SQL->Text = "SELECT `Название издательства` FROM `Издательства`";
	Form4->ADOQuery1->Active = true;
	while (!Form4->ADOQuery1->Eof){
			if (Form4->ADOQuery1->FieldByName("Название издательства")->Text == Form4->Edit1->Text) {
				ShowMessage("Такое значение уже существует");
				return;
			}
			Form4->ADOQuery1->Next();
		}
	Form4->ADOQuery1->SQL->Text = "INSERT INTO `Издательства` VALUES ('" + Form4->Edit1->Text + "','" + Form4->MaskEdit1->Text +"'," + Form4->Edit3->Text + ");";
...
void __fastcall TForm4::FormActivate(TObject *Sender)
{
	...
	Form4->ADOQuery1->Active = true;
	while (!Form4->ADOQuery1->Eof){
			Form4->ComboBox1->Items->Add(Form4->ADOQuery1->FieldByName("Название издательства")->Text);
			Form4->ADOQuery1->Next();
		}
}
//---------------------------------------------------------------------------
...
{
	Form4->ADOQuery1->SQL->Text = "DELETE * FROM `Издательства` WHERE `Название издательства` = '" + Form4->ComboBox1->Items->Strings[Form4->ComboBox1->ItemIndex] + "';";
	Form4->ADOQuery1->ExecSQL();
