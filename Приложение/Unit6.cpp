...
void __fastcall TForm6::FormActivate(TObject *Sender) {
    ...
    Form6->ADOQuery1->SQL->Text = "SELECT `Название книги` FROM `Книги`";
    Form6->ADOQuery1->Active = true;
    while (!Form6->ADOQuery1->Eof) {
        Form6->ComboBox1->Items->Add(Form6->ADOQuery1->FieldByName("Название книги")->Text);
...
void __fastcall TForm6::Button1Click(TObject *Sender) {
    Form6->ADOQuery1->SQL->Text =
            "INSERT INTO `Продажи` (`Название книги`,`Скидка`,`Дата продажи`,`Кол-во`) VALUES ('" +
...
void __fastcall TForm6::Button2Click(TObject *Sender) {
    ...
    Form6->ADOQuery1->SQL->Text =
            "DELETE * FROM Продажи WHERE `Дата продажи` = '" + Form6->DateTimePicker2->Date + "';";
    Form6->ADOQuery1->ExecSQL();
